...
public class ZPNsFCMReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        ZPNsMessage.Builder builder = ZPNsMessage.builder().pushSource(ZPNsConstants.PushSource.FCM).pushMessage(message).title(title).content(content).extras(extraObj.toString()).pushType(ZPNsType.NOTIFICATION_THROUGH);
